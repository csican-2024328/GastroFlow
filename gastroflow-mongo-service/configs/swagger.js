...
const ROUTE_SOURCES = [
  ...
  { mountPath: '/api/v1/mesas', file: '../src/Mesas/mesa.routes.js', tag: 'Mesas' },
  { mountPath: '/api/v1/platos', file: '../src/Platos/platos.routes.js', tag: 'Platos' },
  { mountPath: '/api/v1/menu', file: '../src/Menu/menu.routes.js', tag: 'Menu' },
  { mountPath: '/api/v1/reports', file: '../src/Reports/reports.routes.js', tag: 'Reports' },
  {
    mountPath: '/api/v1/inventory',
    file: '../src/Inventory/inventory.routes.js',
    tag: 'Inventory',
  },
  { mountPath: '/api/v1/orders', file: '../src/Order/order.routes.js', tag: 'Orders' },
  { mountPath: '/api/v1/events', file: '../src/Event/event.routes.js', tag: 'Events' },
  { mountPath: '/api/v1/coupons', file: '../src/Coupon/coupon.routes.js', tag: 'Coupons' },
  {
    mountPath: '/api/v1/reservation',
    file: '../src/Reservation/reservation.routes.js',
    tag: 'Reservation',
  },
  {
    mountPath: '/api/v1/notifications',
    file: '../src/Notifications/notifications.routes.js',
    tag: 'Notifications',
  },
  { mountPath: '/api/v1/invoices', file: '../src/Invoice/invoice.routes.js', tag: 'Invoices' },
  { mountPath: '/api/v1/reviews', file: '../src/Review/review.routes.js', tag: 'Reviews' },
  { mountPath: '/api/v1/staff', file: '../src/Staff/staff.routes.js', tag: 'Staff' },
  {
    mountPath: '/api/v1/inventory-auditoria',
    file: '../src/InventoryMovement/inventoryMovement.routes.js',
    tag: 'InventoryMovement',
  },
];
